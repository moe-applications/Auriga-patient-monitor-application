...
@interface UIHRTrendFormVC ()
@property (strong, nonatomic) EAGLContext * context;
@end

@implementation UIHRTrendFormVC
...
- (void)viewDidLoad {
    ...
    self.preferredFramesPerSecond = kFPS2;
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    while (!self.inputQueue.isEmpty && points < self.inputQueue.size) {
        ...
        sample = sample/50.0f - 0.2f;
        _vertexBuffer[currentIndex].y = sample;
